...
2. Download and add the [stripped dll](https://github.com/ddemile/FakeAchievements/releases/download/0.1.5-beta/Stripped-FakeAchievements.dll) to your project's referenced assemblies and add the mod as a dependency of your mod
